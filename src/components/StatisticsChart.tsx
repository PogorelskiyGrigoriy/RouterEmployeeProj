...
export const StatisticsChart = ({ 
  ...
  return (
    <Container maxW="container.xl" py="8">
      <Heading size="2xl" mb="8" letterSpacing="tight">{title}</Heading>
      <Box p="6" borderWidth="1px" borderRadius="2xl" bg="bg.panel" height="400px" shadow="sm">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            />
            <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: gray500 }} allowDecimals={false} />
            <Tooltip
              cursor={{ fill: gridColor, opacity: 0.5 }}
              contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: 'var(--chakra-shadows-lg)', backgroundColor: 'white' }}
            ...
            />
            <Bar dataKey={dataKeyY} fill={accent} radius={[4, 4, 0, 0]} minPointSize={2} />
          </BarChart>
        </ResponsiveContainer>
      </Box>
    </Container>
